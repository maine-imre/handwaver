Shader "IMRE/EarthShaderBackOnly" {
	Properties {
    _Tint ("Tint Color", Color) = (.5, .5, .5, .5)
    [Gamma] _Exposure ("Exposure", Range(0, 8)) = 1.0
    _Rotation ("Rotation", Range(0, 360)) = 0
    [NoScaleOffset] _Tex ("Spherical  (HDR)", 2D) = "grey" {}
    [KeywordEnum(6 Frames Layout, Latitude Longitude Layout)] 
...
SubShader {
    Tags { "Queue"="Transparent-50" "RenderType"="Transparent" "PreviewType"="Skybox" }
