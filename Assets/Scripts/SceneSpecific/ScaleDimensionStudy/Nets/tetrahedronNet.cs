...
namespace IMRE.HandWaver.ScaleStudy
{
    ...
    /// </summary>
    public class tetrahedronNet : MonoBehaviour, ISliderInput
    {

        static readonly float COMPLETEDFOLD = (180f - Vector3.Angle(
                                                   (Vector3.one - (new Vector3(1, -1, -1) + new Vector3(-1, 1, -1)) /
                                                    2f),
                                                   new Vector3(-1, -1, 1) -
