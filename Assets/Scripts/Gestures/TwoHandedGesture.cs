...
namespace IMRE.Gestures
{
    ...
    protected virtual void WhileGestureInactive(Hand maybeNullLeftHand, Hand maybeNullRightHand) { }
		...
		/// be non-null.
		/// </summary>
		protected void WhenGestureActivated(BodyInput bodyInput)
		{
		...
		/// </summary>
		protected void WhenGestureDeactivated(BodyInput bodyInput, DeactivationReason reason)
		{
		...
		protected bool ShouldGestureActivate(BodyInput bodyInput)
		{
			return GestureEnabled && (ActivationConditions(bodyInput));
		}

		protected bool ShouldGestureDeactivate(BodyInput bodyInput, out DeactivationReason? deactivationReason)
		{
			...
			else if (DeactivationConditions(bodyInput) || !GestureEnabled)
			{
		...
		protected abstract bool ActivationConditions(BodyInput bodyInput);
		protected abstract bool DeactivationConditions(BodyInput bodyInput);
